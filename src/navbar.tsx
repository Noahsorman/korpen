...
import { Users, Trophy, BookOpenCheck, CirclePile, Calendar } from 'lucide-react'; // Installera med: npm install lucide-react
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/schedule', label: 'Spelschema', icon: <Calendar size={20} />},
